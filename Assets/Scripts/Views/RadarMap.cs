...

{
    ...
    public class RadarMap : BaseObjectScene
    {
        ...
        public static void RegisterRadarObject(GameObject o, Image i)
        {
            ...
            RadObjects.Add(new RadarObject { Owner = o, Icon = Instantiate(i) });
        }
        ...
        private void DrawRadarDots() // Синхронизирует значки на миникарте с реальными объектами
        {
            foreach (RadarObject radObject in RadObjects)
            {
                ...
                float deltay = Mathf.Atan2(radarPos.x, radarPos.z) * Mathf.Rad2Deg - 90 - _playerPos.rotation.eulerAngles.y;
